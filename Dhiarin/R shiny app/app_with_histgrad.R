...
ui <- navbarPage(
             ...
             fluidRow(
               ...
               column(
                 ...
                 div(
                   ...
                   # Model selection - ADD HISTGRADBOOST OPTION
                   selectInput("model_type", "Select Model Type:",
                               choices = c("Binary Logistic", "Multinomial Logistic", "HistGradientBoosting"),
  ...
  tabPanel("Histogram Explorer",
           fluidPage(
             ...
             sidebarLayout(
               sidebarPanel(
                 selectInput("var_select", "Select a numeric variable:",
             ...
             sidebarLayout(
               sidebarPanel(
                 selectInput("x_var", "Select X-axis variable:",
                             choices = c("PREMIUM", "INCOME", "TERM", "PAYFREQ", "AGE_AT_COMMENCEMENT", "nbanks", "nloans", "ps_lapse1"),
                             selected = "INCOME"),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$predict_btn, {
    ...
    new_data <- data.frame(
      ...
      INCOME = input$INCOME,
      TERM = input$TERM,
      PAYER_AGE_GROUP = factor(input$AGE_AT_COMMENCEMENT, levels = c("18-25", "26-35", "36-45", "46-55")),
  ...
  # Keep existing histogram and scatter plot logic...
  output$hist_plot <- renderPlot({
    ...
    hist(x, breaks = input$bins, col = "skyblue", border = "white",
         ...
         xlab = input$var_select, ylab = "Frequency")
  })
  ...
  output$scatter_plot <- renderPlot({
    ...
    plot(x, y, xlab = input$x_var, ylab = input$y_var,
